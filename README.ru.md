...
Инспектор не печатает значения учётных данных. Он показывает структуру и имена зарегистрированных возможностей.
...
Готовый нейтральный шаблон лежит в [`examples/multi-agent`](examples/multi-agent/README.ru.md). В нём роли не привязаны к конкретной модели: можно оставить наследование настроек родителя или задать модель локально.
...
См. [CONTRIBUTING.ru.md](CONTRIBUTING.ru.md). Проект распространяется по [лицензии MIT](LICENSE).
